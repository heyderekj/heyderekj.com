...
export const customerioLetter = {
  ...
  paragraphs: [
    ...
    "AI has completely changed my world as a designer who loves building. I can go further, faster—from idea to a real flow people can try, not just a polished frame. I’ve written about how I think AI should show up in products: subtle, useful, not a checkbox.",
